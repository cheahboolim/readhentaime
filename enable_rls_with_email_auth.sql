-- Re-enable Row Level Security with updated admin policies
-- This script will work with any user that has the authorized emails
...
-- Create policies that check for authorized emails instead of specific UUIDs
-- This is more flexible and matches your app's authorization logic

-- Ads table policies
CREATE POLICY "Admin full access to ads" ON public.ads
  FOR ALL USING (
    auth.uid() IS NOT NULL AND 
    auth.jwt() ->> 'email' IN ('cheahboolim@gmail.com', 'testuser@gmail.com')
  );
